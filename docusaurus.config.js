...
const config = {
  ...
  url: 'https://induction.cenos-platform.com',
  ...
  organizationName: 'update-if-needed', // Usually your GitHub org/user name.
  projectName: 'update-if-needed', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            to: 'https://www.cenos-platform.com/inductionheating',
            label: 'CENOS Home',
            position: 'right',
          },
        ],
